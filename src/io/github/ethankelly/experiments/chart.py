...
boxplot = sns.boxplot(x="probability", y="result", data=dataframe[dataframe["probability"] >= 0],
                         showfliers=False)
# sns.stripplot(x="probability", y="result", data=dataframe[dataframe["probability"] >= 0], marker="o", alpha=0.3,
#               color="black", linewidth=1)
boxplot.axes.set_title("Numbers of equations required to describe ER\ngraphs with increasing probabilities",
                       fontsize=22)
